...
This is the lowest level of heading that should be used. Subordinate levels are too small to read in HTML. Sed velit urna, interdum vel, ultricies vel, faucibus at, quam. Donec elit est, consectetuer eget, consequat quis, tempus quis, wisi.  
...
It appears under the "Normal" style, but will not be listed in ToC or indexes. Any heading subordinate to "H7" (e.g., "H8", "H9" etc) will have the same properties of "H7". It will appear as the same as subheading H7 ("Normal") and not indexed. In a github document it will appear as a H1 level header and for this reason should be avoided for cross-compatibility.    
...
Note that you cannot use kable() to print tables in Word. You can print pretty tables in HTML and Word using flextable like this:  
...
#   knitr::kable(
#     format = "html",
#     caption = "Table 1. Heading style is named table heading")
```
